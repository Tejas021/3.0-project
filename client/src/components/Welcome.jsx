...
const Welcome = () => {
  ...
  const {sendTransaction,connectWallet,connectedAccount,handleChange,formData} = useContext(TransactionContext);
        ...
        <div className="w-full items-center flex justify-center">
           <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
               <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
                   <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">Send Crypto <br/> To the World</h1>
              
                    <p className="text-white font-light text-left mt-5 md:w-9/12 w-ll/12 text-base ">
                        Explore the CryptoWorld .Buy And sell cryptocurrencies very easily on Krypto
                    </p>
{
  !connectedAccount&&(     <button
    type="button"
 onClick={connectWallet}
    className="flex flex-row justify-center items-center my-5 border-[1px] border-[#3d4f7c] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
  >
